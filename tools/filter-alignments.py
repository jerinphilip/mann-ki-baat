...
def parallel_write(src_lang, src_entry, tgt_lang, tgt_entry):
    src_out = open('./mkb/{}-{}/mkb.filt.{}'.format(src_lang, tgt_lang, src_lang),'a')
    tgt_out = open('./mkb/{}-{}/mkb.filt.{}'.format(src_lang, tgt_lang, tgt_lang),'a')
...
if __name__ == '__main__':
    ...
    src_file = open('./mkb/{}-{}/mkb.{}'.format(src_lang, tgt_lang, src_lang),'r')
    tgt_file = open('./mkb/{}-{}/mkb.{}'.format(src_lang, tgt_lang, tgt_lang),'r')
